...
typedef struct smdevtools_option smdevtools_option_t;

struct smdevtools_option
{
...
void smdevtools_getopt_wrapped_fprint(
      FILE *stream,
...
void smdevtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const smdevtools_option_t *options,
      int number_of_options );

int smdevtools_getopt_get_options_string(
     const smdevtools_option_t *options,
     int number_of_options,
